...
+ (void)addDoNotBackupAttribute:(NSString *)path {
    ...
    if (error) {
        GSNLog(@"error to set do not backup attribute, error = %@", error);
    }
}
...
@implementation GSRootRequest (RequestAccessory)

- (void)toggleAccessoriesWillStartCallBack {
    for (id<GSRequestAccessory> accessory in self.requestAccessories) {
...
@implementation GSBatchRequest (RequestAccessory)
...
@implementation GSChainRequest (RequestAccessory)
