...
@implementation GSAnimatingRequestAccessory
...
- (void)requestWillStart:(id)request {
    if (_animatingView) {
        dispatch_async(dispatch_get_main_queue(), ^{
            // TODO: show loading
            // [AlertUtils showLoadingAlertView:_animatingText inView:_animatingView];
            NSLog(@" loading start");
        });
    }
}
...
- (void)requestWillStop:(id)request {
    if (_animatingView) {
        dispatch_async(dispatch_get_main_queue(), ^{
            // TODO: hide loading
            //[AlertUtils hideLoadingAlertView:_animatingView];
